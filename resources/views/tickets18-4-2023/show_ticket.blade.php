                ...
                {{ csrf_field() }}
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-7" id='settlement'>
                                            @if($ticket_data->ticket_multiple_settlements)
                                                @foreach($ticket_data->ticket_multiple_settlements as $val)
                                                    <input @if($ticket_data->current_group[0]->id != 1 ) ? readonly : "" @endif type="text" value="{{$val->amount}}"  name="settlement[]"  class="form-control amount-formate" {{ $disabled }} placeholder="Amount">
                                                @endforeach
                                            @endif
                                        </div>
                            ...
                            @endif
                            <a href="{{url('/tickets/ticket-logs/'.$ticket_data->id)}}">Logs</a>
                            </br>
