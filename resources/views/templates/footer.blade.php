		...
		<script>
			$('._remove').on('click', function(){
				...
				function add_new_settlement_fields() {
					...
					{
						$message_content = `<div class='row'><div class="col-md-7" id='settlement'><input type="text" value=""  name="settlement[]"  class="form-control" ></div><div class="col-md-5" id='settlement_account'><input type="text"  name="account[]"  class="form-control" ></div></div>`;
