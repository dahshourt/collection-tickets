                    ...
                    <form name="add-blog-post-form" id="add-blog-post-form" method="get" action="{{url('report/entrp-report-result')}}">
                        <div class="card-body">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" placeholder="Enter Ticket Creation Date" name="created_at" />
                            </div>
                            <div class="form-group col-md-6">
                                <label>Bank transaction date</label>
                                <input type="date" class="form-control" placeholder="Enter Bank Transaction Date" name="bank_transaction_date" />
                            </div>
                            <div class="form-group col-md-6">
                                <label>Amount</label>
                                <input type="number" class="form-control" placeholder="Enter Amount" name="transaction_amount" />
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label>Oracle field updated date</label>
                                <input type="date" class="form-control" placeholder="Enter Oracle Date" name="add_on_oracle_date" />
                            </div>
                            <div class="form-group col-md-6">
